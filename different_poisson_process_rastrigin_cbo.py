# -*- coding: utf-8 -*-
"""Different Poisson process Rastrigin CBO.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12_f5ncsbdT56fJInj5RUmXmupevMbrVB
"""
...
agents = [20,50,80,100,150] # x_min lekr kia hua exp
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 30), pos_vec = 30, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -50, upper_limit = 50, m=20)
...
agents = [20,50,80,100] # x_min lekr kia hua exp 
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 30), pos_vec = 30, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -20, upper_limit = 20, m=100)

agents = [20,50,70,100] # x_min ke bina alpha  = 30
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 20), pos_vec = 20, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -3, upper_limit = 3, m=100)

agents = [20,50,70,100] # x_min ke bina alpha  =30 with sigma 5.1
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 20), pos_vec = 20, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -6, upper_limit = 6, m=100)

agents = [20,50,70,100] # x_min ke bina alpha  =30 with sigma 5
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 20), pos_vec = 20, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -6, upper_limit = 6, m=100)

agents = [20,50,70,100] # x_min ke bina alpha  =20
for k in agents:
  basecbo = BaseCBO(function = rastrigin(dim = 20), pos_vec = 20,alpha = 20, n_agents = k, total_time = 100)
  success_rate(basecbo,lower_limit = -6, upper_limit = 6, m=100)

agents = [20, 50, 80, 100]
for k in agents:
  jumpcbo = JumpCBO(function = rastrigin(dim = 20), pos_vec = 20, n_agents = k, beta = 3, total_time = 100, alpha = 30, lambda_val = 20, type_rv="poisson")
